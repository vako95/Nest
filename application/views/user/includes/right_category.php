                ...
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                     <?php foreach($categories_list as $categories_list_item): ?>
                        <li>
                            <a href='<?php echo base_url('shop/categories/'.$categories_list_item->c_product_slug); ?>'> <img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/category-2.svg" alt="" /><?= $categories_list_item->c_product_name; ?></a><span class="count">35</span>
                        </li>
                    <?php endforeach; ?>
                    </ul>
                </div>
