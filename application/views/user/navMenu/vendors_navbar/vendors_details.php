...
<main class="main">
    ...
    <div class="container mb-30">
        <div class="archive-header-3 mt-30 mb-80" style="background-image: url(<?php echo base_url('public/user/'); ?>assets/imgs/vendor/vendor-header-bg.png)">
            <div class="archive-header-3-inner">
                <div class="vendor-logo mr-50">
                    <img src="<?php echo base_url('public/user/'); ?>assets/imgs/vendor/vendor-17.png" alt="" />
                </div>
                <div class="vendor-content">
                    <div class="product-category">
                        <span class="text-muted">Since 2012</span>
                    </div>
                    <h3 class="mb-5 text-white"><a class='text-white' href='/vendor-details-1'>Nest Food.,Ltd</a></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="vendor-info text-white mb-15">
                                <ul class="font-sm">
                                    <li><img class="mr-5" src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>5171 W Campbell Ave undefined, Utah 53127 United States</span></li>
                                    <li><img class="mr-5" src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us:</strong><span>(+91) - 540-025-124553</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="follow-social">
                                ...
                                <ul class="social-network">
                                    <li class="hover-up">
                                        <a href="#">
                                            <img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/social-tw.svg" alt="" />
                                        </a>
                                    </li>
                                    <li class="hover-up">
                                        <a href="#">
                                            <img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/social-fb.svg" alt="" />
                                        </a>
                                    </li>
                                    <li class="hover-up">
                                        <a href="#">
                                            <img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/social-insta.svg" alt="" />
                                        </a>
                                    </li>
                                    <li class="hover-up">
                                        <a href="#">
                                            <img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/social-pin.svg" alt="" />
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="row flex-row-reverse">
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                <div class="banner-img mb-30">
                    <img src="<?php echo base_url('public/user/'); ?>assets/imgs/banner/banner-10.jpg" alt="" />
                </div>
