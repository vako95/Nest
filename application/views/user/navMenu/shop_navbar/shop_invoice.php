...
<div class="invoice invoice-content invoice-1">
    <div class="back-top-home hover-up mt-30 ml-30">
        <a class='hover-up' href='/'><i class="fi-rs-home mr-5"></i> Homepage</a>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="invoice-inner">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="invoice-name">
                                        <div class="logo">
                                            <a href='/'><img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/logo-light.svg" alt="logo" /></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div class="invoice-btn-section clearfix d-print-none">
                        <a href="javascript:window.print()" class="btn btn-lg btn-custom btn-print hover-up"> <img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-print.svg" alt="" /> Print </a>
                        <a id="invoice_download_btn" class="btn btn-lg btn-custom btn-download hover-up"> <img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-download.svg" alt="" /> Download </a>
                    </div>
                </div>
            </div>
        </div>
