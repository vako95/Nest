            ...
            <div class="col-lg-5">
                <div class="border p-40 cart-totals ml-30 mb-50">
                    ...
                    <div class="table-responsive order_table checkout">
                        <table class="table no-border">
                            <tbody>
                                <tr>
                                    <td class="image product-thumbnail"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/product-1-1.jpg" alt="#"></td>
                                    <td>
                                        <h6 class="w-160 mb-5"><a class='text-heading' href='/shop-product-full'>Yidarton Women Summer Blue</a></h6></span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="w-160 mb-5"><a class='text-heading' href='/shop-product-full'>Seeds of Change Organic Quinoa</a></h6></span>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width:90%">
                                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="w-160 mb-5"><a class='text-heading' href='/shop-product-full'>Angie’s Boomchickapop Sweet </a></h6></span>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width:90%">
                                                </div>
                ...
                <div class="payment ml-30">
                    ...
                    <div class="payment-logo d-flex">
                        <img class="mr-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/payment-paypal.svg" alt="">
                        <img class="mr-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/payment-visa.svg" alt="">
                        <img class="mr-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/payment-master.svg" alt="">
                        <img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/payment-zapper.svg" alt="">
                    </div>
