                    ...
                    <table class="table text-center table-compare">
                        <tbody>
                            <tr class="pr_image">
                                ...
                                <td class="row_img"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/product-2-1.jpg" alt="compare-img" /></td>
                                <td class="row_img"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/product-1-1.jpg" alt="compare-img" /></td>
                                <td class="row_img"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/product-3-1.jpg" alt="compare-img" /></td>
                            </tr>
                            <tr class="pr_title">
                                <td class="text-muted font-sm fw-600 font-heading">Name</td>
                                <td class="product_name">
                                    <h6><a class='text-heading' href='/shop-product-full'>J.Crew Mercantile Women's Short</a></h6>
                                </td>
                                <td class="product_name">
                                    <h6><a class='text-heading' href='/shop-product-full'>Amazon Essentials Women's Tanks</a></h6>
                                </td>
                                <td class="product_name">
                                    <h6><a class='text-heading' href='/shop-product-full'>Amazon Brand - Daily Ritual Wom</a></h6>
                                </td>
                            </tr>
                            <tr class="pr_price">
