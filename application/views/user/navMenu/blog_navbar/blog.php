                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter mb-50 pr-30">
                            <div class="totall-product">
                                <h2>
                                    <img class="w-36px mr-10" src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/category-1.svg" alt="" />
                                    Recips Articles
                                </h2>
                            </div>
                        ...
                        <div class="loop-grid pr-30">
                            <div class="row">
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-1.png" alt="" />
                                        </a>
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-2.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-3.png" alt="" />
                                        </a>
                                        <div class="entry-meta">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-4.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-5.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-6.png" alt="" />
                                        </a>
                                        <div class="entry-meta">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-7.png" alt="" />
                                        </a>
                                        <div class="entry-meta">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-8.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                        <h6 class="mb-10 font-sm"><a class='entry-meta text-muted' href='/blog-category-grid'>Side Dish</a></h6>
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-9.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-10.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                        <h6 class="mb-10 font-sm"><a class='entry-meta text-muted' href='/blog-category-grid'>Salad</a></h6>
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-12.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-13.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                        <h6 class="mb-10 font-sm"><a class='entry-meta text-muted' href='/blog-category-grid'> Dessert </a></h6>
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-14.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                        <h6 class="mb-10 font-sm"><a class='entry-meta text-muted' href='/blog-category-grid'>Vegetarian</a></h6>
                                ...
                                <article class="col-xl-4 col-lg-6 col-md-6 text-center hover-up mb-30 animated">
                                    <div class="post-thumb">
                                        <a href='/blog-post-right'>
                                            <img class="border-radius-15" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-15.png" alt="" />
                                        </a>
                                    </div>
                                    <div class="entry-content-2">
                                        <h6 class="mb-10 font-sm"><a class='entry-meta text-muted' href='/blog-category-grid'>Vegetarian</a></h6>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget product-sidebar mb-50 p-30 bg-grey border-radius-10">
                                ...
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/thumbnail-6.jpg" alt="#" />
                                    </div>
                                    <div class="content pt-10">
                            ...
                            <div class="sidebar-widget widget_instagram mb-50">
                                ...
                                <div class="instagram-gellay">
                                    <ul class="insta-feed">
                                        <li>
                                            <a href="#"><img class="border-radius-5" src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/thumbnail-1.jpg" alt="" /></a>
                                        </li>
                                        <li>
                                            <a href="#"><img class="border-radius-5" src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/thumbnail-2.jpg" alt="" /></a>
                                        </li>
                                        <li>
                                            <a href="#"><img class="border-radius-5" src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/thumbnail-3.jpg" alt="" /></a>
                                        </li>
                                        <li>
                                            <a href="#"><img class="border-radius-5" src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/thumbnail-4.jpg" alt="" /></a>
                                        </li>
                                        <li>
                                            <a href="#"><img class="border-radius-5" src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/thumbnail-5.jpg" alt="" /></a>
                                        </li>
                                        <li>
                                            <a href="#"><img class="border-radius-5" src="<?php echo base_url('public/user/'); ?>assets/imgs/shop/thumbnail-6.jpg" alt="" /></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
