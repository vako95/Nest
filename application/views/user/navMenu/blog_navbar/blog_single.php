                        ...
                        <div class="col-lg-9">
                            <div class="single-page pt-50 pr-30">
                                            ...
                                            <div class="single-header-meta">
                                                <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                                    <a class="author-avatar" href="#">
                                                        <img class="img-circle" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/author-1.png" alt="" />
                                                    </a>
                                                ...
                                                <div class="social-icons single-share">
                                                    <ul class="text-grey-5 d-inline-block">
                                                        <li class="mr-5">
                                                            <a href="#"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-bookmark.svg" alt="" /></a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-heart-2.svg" alt="" /></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <figure class="single-thumbnail">
                                    <img src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-19.png" alt="" />
                                </figure>
                                <div class="single-content">
                                    <div class="row">
                                        <div class="col-xl-10 col-lg-12 m-auto">
                                            ...
                                            <img class="mb-30" src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/blog-21.png" alt="" />
                                            ...
                                            <div class="entry-bottom mt-50 mb-30">
                                                <div class="tags w-50 w-sm-100">
                                                    <a class='hover-up btn btn-sm btn-rounded mr-10' href='/blog-category-big' rel='tag'>deer</a>
                                                    <a class='hover-up btn btn-sm btn-rounded mr-10' href='/blog-category-big' rel='tag'>nature</a>
                                                    <a class='hover-up btn btn-sm btn-rounded mr-10' href='/blog-category-big' rel='tag'>conserve</a>
                                                </div>
                                                <div class="social-icons single-share">
                                                    <ul class="text-grey-5 d-inline-block">
                                                        <li><strong class="mr-10">Share this:</strong></li>
                                                        <li class="social-facebook">
                                                            <a href="#"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-facebook.svg" alt="" /></a>
                                                        </li>
                                                        <li class="social-twitter">
                                                            <a href="#"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-twitter.svg" alt="" /></a>
                                                        </li>
                                                        <li class="social-instagram">
                                                            <a href="#"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-instagram.svg" alt="" /></a>
                                                        </li>
                                                        <li class="social-linkedin">
                                                            <a href="#"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/theme/icons/icon-pinterest.svg" alt="" /></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="author-bio p-30 mt-50 border-radius-15 bg-white">
                                                <div class="author-image mb-30">
                                                    <a href="author.html"><img src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/author-1.png" alt="" class="avatar" /></a>
                                                        ...
                                                        <div class="comments-area">
                                                            ...
                                                            <div class="comment-list">
                                                                <div class="single-comment justify-content-between d-flex mb-30">
                                                                    <div class="user justify-content-between d-flex">
                                                                        <div class="thumb text-center">
                                                                            <img src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/author-2.png" alt="" />
                                                                ...
                                                                <div class="single-comment justify-content-between d-flex mb-30 ml-30">
                                                                    <div class="user justify-content-between d-flex">
                                                                        <div class="thumb text-center">
                                                                            <img src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/author-3.png" alt="" />
                                                                ...
                                                                <div class="single-comment justify-content-between d-flex">
                                                                    <div class="user justify-content-between d-flex">
                                                                        <div class="thumb text-center">
                                                                            <img src="<?php echo base_url('public/user/'); ?>assets/imgs/blog/author-4.png" alt="" />
