                            ...
                            <div class="header-action-2">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href='/shop-product-right'><img alt="Nest" src="assets/imgs/shop/thumbnail-3.jpg" /></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href='/shop-product-right'><img alt="Nest" src="assets/imgs/shop/thumbnail-2.jpg" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            <li><a href='/page-account'><i class="fi fi-rs-user mr-10"></i>My Account</a></li>
                                            <li><a href='/page-account'><i class="fi fi-rs-location-alt mr-10"></i>Order Tracking</a></li>
                                            <li><a href='/page-account'><i class="fi fi-rs-label mr-10"></i>My Voucher</a></li>
                                            <li><a href='/shop-wishlist'><i class="fi fi-rs-heart mr-10"></i>My Wishlist</a></li>
                                            <li><a href='/page-account'><i class="fi fi-rs-settings-sliders mr-10"></i>Setting</a></li>
                                            <li><a href='/page-login'><i class="fi fi-rs-sign-out mr-10"></i>Sign out</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    <li class="hot-deals"><img src="assets/imgs/theme/icons/icon-hot.svg" alt="hot deals" /><a href='/shop-grid-right'>Deals</a></li>
                                    <li>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href='/shop-product-right'><img alt="Nest" src="assets/imgs/shop/thumbnail-4.jpg" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
