            ...
            <div class="container">
                <div class="section-title style-2 wow animate__animated animate__fadeIn">
                    ...
                    <ul class="nav nav-tabs links" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two" type="button" role="tab" aria-controls="tab-two" aria-selected="false"></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            
                                <a href="<?= base_url('shop/categories/cofee_tea');?>">cofee && tea</a>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                        <div class="row product-grid-4">
                            <?php foreach($product_list  as $product_list_item) { ?>
                                ...
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href='/shop-grid-right'><?= $product_list_item->c_product_name ?></a>
                                        </div>
                                        <h2><a href='/shop-product-right'></a></h2>
                                        ...
                                        <div class="product-card-bottom">
                                            <div class="product-price">
                                                <span></span>
                                                <span class="old-price"><?= $product_list_item->s_description ?></span>
                                            </div>
                                            <div class="add-cart">
