...
<section class="content-main sweatbody ">
    ...
    <div class="row sweatbody ">
        ...
        <form action="<?php echo base_url('admin_creat_product_act'); ?>" method="post" enctype="multipart/form-data" id="form_product">
            <?php
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input name="width" id="widther" type="text" placeholder="inch" class="form-control" id="product_name" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-4">
