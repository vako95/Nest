                    ...
                    <tbody>
                        <tr>
                            <td width="40%">
                                <a href="#" class="itemside">
                                    <div class="left">
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/people/avatar-1.png" class="img-sm img-avatar" alt="Userpic" />
                                    </div>
                                    <div class="info pl-3">
                        ...
                        <tr>
                            <td width="40%">
                                <a href="#" class="itemside">
                                    <div class="left">
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/people/avatar-2.png" class="img-sm img-avatar" alt="Userpic" />
                                    </div>
                                    <div class="info pl-3">
                        ...
                        <tr>
                            <td width="40%">
                                <a href="#" class="itemside">
                                    <div class="left">
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/people/avatar-3.png" class="img-sm img-avatar" alt="Userpic" />
                                    </div>
                                    <div class="info pl-3">
                        ...
                        <tr>
                            <td width="40%">
                                <a href="#" class="itemside">
                                    <div class="left">
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/people/avatar-4.png" class="img-sm img-avatar" alt="Userpic" />
                                    </div>
                                    <div class="info pl-3">
                                        <h6 class="mb-0 title">Eleanor Pena</h6>
                                        <small class="text-muted">Seller ID: #439</small>
