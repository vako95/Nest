                            ...
                            <td>
                                <ul class="rating-stars">
                                    <li style="width: 60%" class="stars-active">
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/icons/stars-active.svg" alt="stars" />
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/icons/starts-disable.svg" alt="stars" />
                                    </li>
                                </ul>
                            </td>
                            <td>10.03.2020</td>
