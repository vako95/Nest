                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="icontext">
                                            <img class="icon border" src="<?php echo base_url('public/admin/'); ?>assets/imgs/card-brands/1.png" alt="Payment" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="icontext">
                                            <img class="icon border" src="<?php echo base_url('public/admin/'); ?>assets/imgs/card-brands/2.png" alt="Payment" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="icontext">
                                            <img class="icon border" src="<?php echo base_url('public/admin/'); ?>assets/imgs/card-brands/3.png" alt="Payment" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="icontext">
                                            <img class="icon border" src="<?php echo base_url('public/admin/'); ?>assets/imgs/card-brands/4.png" alt="Payment" />
