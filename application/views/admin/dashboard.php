                            ...
                            <div class="new-member-list">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/people/avatar-4.png" alt="" class="avatar" />
                                        <div>
                                            <h6>Patric Adams</h6>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/people/avatar-2.png" alt="" class="avatar" />
                                        <div>
                                            <h6>Dilan Specter</h6>
                                            <p class="text-muted font-xs">Sanfrancisco</p>
                                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo base_url('public/admin/'); ?>assets/imgs/people/avatar-3.png" alt="" class="avatar" />
                                        <div>
                                            <h6>Tomas Baker</h6>
                                            <p class="text-muted font-xs">Sanfrancisco</p>
                                        </div>
        ...
        <header class="card-header">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-2 col-6">
                    <input type="date" value="21.01.2024" class="form-control" />
